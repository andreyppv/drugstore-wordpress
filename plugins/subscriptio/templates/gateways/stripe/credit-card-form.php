...
<?php if (!empty($description) || $is_debug): ?>
    <div class="subscriptio_stripe_description">
       ...
       <?php echo $is_debug ? sprintf(__('Click %shere%s for a list of test card numbers.', 'subscriptio-stripe'), '<a href="https://stripe.com/docs/testing" target="_blank">', '</a>') . '<br><br>' : ''; ?>
