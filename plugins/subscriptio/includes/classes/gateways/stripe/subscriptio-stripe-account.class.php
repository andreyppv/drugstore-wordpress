...
class Subscriptio_Stripe_Account
{
    ...
    public function delete_card()
    {
        ...
        Subscriptio::add_woocommerce_frontend_notice(__('Credit card deleted successfully.', 'subscriptio-stripe'));
    ...
    public function card_make_default()
    {
        ...
        // Show success message
        Subscriptio::add_woocommerce_frontend_notice(__('Default card changed successfully.', 'subscriptio-stripe'));
        wp_safe_redirect(get_permalink(woocommerce_get_page_id('myaccount')));
        exit;
    }
