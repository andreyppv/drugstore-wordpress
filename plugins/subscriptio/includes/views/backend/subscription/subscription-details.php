...
<div id="subscription_data">
    ...
    <div class="subscription_data_container">
        ...
        <div class="subscription_data_content">
            ...
            <?php if ($scheduled_order = Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_order', $subscription->id)): ?>
                <p>
            ...
            <?php if ($scheduled_reminder = Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_reminder', $subscription->id)): ?>
                <p>
            ...
            <?php if ($scheduled_payment = Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_payment', $subscription->id)): ?>
                <p>
            ...
            <?php if ($scheduled_suspension = Subscriptio_Scheduler::get_scheduled_event_timestamp('subscriptio_scheduled_suspension', $subscription->id)): ?>
                <p>
