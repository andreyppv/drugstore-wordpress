...
class CMODSAR_Replacement
{
    ...
    public static function addSearchAndReplaceReplacementTabContent($content)
    {
        ...
        <div class="block">
            ...
            <p>This plugin allows you to setup the search & replace rules for the content of your site.
                You can set the string/HTML which should be found and the string/HTML that should be placed instead. You may also decide only to remove without replacing it.
            </p>
            <p>
                This does not change the content on the database. Instead it changes the content right before it's displayed.
            </p>
            <?php
