...
//			add_action( 'cminds-' . $aboutPageKey . '-content-5', array( $this, 'displayUpgradeToProTab' ) );
		...
		public function showAuthor() {
			...
			$authorUrl .= '<a href="' . $this->addAffiliateCode( 'https://www.cminds.com/' ) . '" target="_blank" class="cminds_poweredbylink">CreativeMinds WordPress</a>';
			$authorUrl .= ' <a href="' . $this->addAffiliateCode( 'https://www.cminds.com/' ) . '" target="_blank" class="cminds_poweredbylink">Plugin</a>';
			$authorUrl .= ' <a href="' . $this->addAffiliateCode( $this->getOption( 'plugin-store-url' ) ) . '" target="_blank" class="cminds_poweredbylink">' . $this->getOption( 'plugin-name' ) . '</a>';
