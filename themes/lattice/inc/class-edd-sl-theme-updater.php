<?php
/**
 * Integrate Lattice with Easy Digital Downloads Software License plugin.
 * This allows for the theme to receive updates.
 *
 */
class EDD_SL_Theme_Updater {
	...
	public function theme_update_transient( $value ) {
		...
		return $value;
	} // end theme_update_transient

	public function delete_theme_update_transient() {
		delete_transient( $this->response_key );
	} // end delete_theme_update_transient
